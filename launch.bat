...
start "MS-RESENAS" java -jar ms-resenas\\target\\cl-factogames-resenas-0.0.1-SNAPSHOT.jar --spring.profiles.active=test
...
cls
echo.
echo ===== Iniciando ms-resenas =====
start "MS-RESENAS" mvn -f ms-resenas spring-boot:run
echo ms-resenas iniciado.
pause
goto MENU
