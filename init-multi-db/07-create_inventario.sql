...
CREATE TABLE stock_productos (
    ...
    CONSTRAINT uq_juego_almacen UNIQUE (id_juego, id_almacen)
);
...
CREATE INDEX idx_stock_juego ON stock_productos(id_juego);
...
INSERT INTO stock_productos (id_juego, id_almacen, cantidad) VALUES 
(1, 1, 500), -- Elden Ring (Digital): Stock de sobra
(2, 2, 2),   -- Zelda (Físico): Stock crítico
(3, 3, 0);   -- FIFA 24 (Físico): Agotado
